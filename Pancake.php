    ...
    <div class="container mt-5">
        ...
        <div class="card my-2 accordion" id="accordionExample">
            <div class="card-header">
                <p class="fw-bold my-auto">Shira - Commanda <code>{ / }</code></p>
                <p>ใช้ลิ้งค์จาก YouTube เปิดเพลงได้</p>
            </div>
...
<script>
    function copyText() {
        // เลือก element ที่มีข้อความ
        const textToCopy = document.getElementById('textToCopy');

        // สร้าง object range และเลือกข้อความ
        ...
        // ตัวอย่างการให้ผู้ใช้มีข้อมูลเพิ่มเติม (ในกรณีนี้คือ alert)
        alert('ข้อความถูกคัดลอกไปยังคลิปบอร์ดแล้ว');
    }
</script>
